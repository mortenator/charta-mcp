...
exports.CHART_SCHEMAS = exports.CHART_TYPE_INFO = void 0;
exports.CHART_TYPE_INFO = [
    {
        type: "bar",
        description: "Vertical bars comparing values across categories. Best for comparing magnitudes.",
    ...
    {
        type: "grouped-bar",
        description: "Side-by-side bars for multiple series. Best for comparing groups across categories.",
    ...
    {
        type: "stacked-bar",
        description: "Stacked bars showing composition and totals. Best for part-to-whole relationships over categories.",
    ...
    {
        type: "waterfall",
        description: "Floating bars showing cumulative effect of sequential values. Best for financial bridges and variance analysis.",
        dataShape: "Array of {label: string, value: number, isTotal?: boolean}. Positive values go up, negative go down. isTotal=true renders a full bar from zero.",
        example: [
    ...
    {
        type: "line",
        description: "Connected points showing trends over time. Best for continuous data and time series.",
    ...
    {
        type: "area",
        description: "Line chart with filled area. Best for showing volume/magnitude of trends.",
        dataShape: "Array of {label: string, value: number}",
        example: [
            { label: "Jan", value: 100 },
            { label: "Feb", value: 120 },
    ...
    {
        type: "pie",
        description: "Circular chart showing proportions. Best for part-to-whole with few categories (≤6).",
        dataShape: "Array of {label: string, value: number}",
        example: [
    ...
    {
        type: "donut",
        description: "Pie chart with hole in center. Same use case as pie, allows center label.",
        dataShape: "Array of {label: string, value: number}",
        example: [
    ...
    {
        type: "scatter",
        description: "Points on X-Y axes showing correlation. Best for relationships between two variables.",
    ...
    {
        type: "bubble",
        description: "Scatter plot with variable point sizes. Best for three-variable relationships.",
    ...
    {
        type: "gantt",
        description: "Horizontal bars on timeline. Best for project schedules and task durations.",
    ...
    {
        type: "mekko",
        description: "Variable-width stacked bars (Marimekko). Best for market share and segment analysis.",
    ...
    {
        type: "radar",
        description: "Spider/web chart showing multiple dimensions. Best for comparing profiles across dimensions.",
    ...
    {
        type: "heatmap",
        description: "Color-coded grid matrix. Best for showing patterns across two categorical dimensions.",
