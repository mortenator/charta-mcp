...
exports.generateScatterChart = generateScatterChart;
...
function generateScatterChart(input) {
    ...
    const xPx = (v) => padLeft + ((v - xAxisMin) / (xAxisMax - xAxisMin)) * chartW;
    const yPx = (v) => padTop + chartH * (1 - (v - niceYMin) / yRange);
